...
class Sample:
    """Абстрактный суперкласс для всех образцов."""
...
class KnownSample(Sample):
    """Абстрактный суперкласс для тренировочных и тестовых данных, тип данных задается дополнительно."""
...
class Distance:
    """Определение формулы расстояния."""
...
class Chebyshev(Distance):
    """
    Вычисляет расстояние Чебышева между двумя образцами.
...
class Minkowski(Distance):
    """Абстракция для обеспечения способа реализации манхэттенского и евклидова расстояний."""
...
class Minkowski_2(Distance):
    """Общий способ реализации манхэттенского, евклидового расстояния и расстояния Чебышева.
...
class Hyperparameter:
    """Значение гиперпараметра и значение качества классификации."""
...
class TrainingData:
    ...
    def load(self, raw_data_iter: Iterable[dict[str, str]]) -> None:
        """Извлекает TestingKnownSample и TrainingKnownSample из сырых данных."""
...
# Особый случай – абстрактные суперклассы не часто тестируют.
# В этом примере, однако, мы можем создавать экземпляры абстрактного класса.
